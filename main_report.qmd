...
```{r}
#| label: tbl-data_hujan
#| tbl-cap: "Data Hujan Maksimum."
#| warning: false
#| echo: false
...
data_Hjn <- read_csv("raw_data/data_hjn.csv", 
    col_types = cols(date = col_date(format = "%d/%m/%Y"), 
        rainfall = col_number()))

rename <- c("Tanggal observasi","curah hujan (mm)")
colnames(data_Hjn) <- rename

kbl(summary(data_Hjn))

gt_plt_summary(data_Hjn)

summarytools::dfSummary(data_Hjn) |> stview()
