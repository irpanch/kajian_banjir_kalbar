...
dlf_P <- distLfit(data_filter$rahadi_oesman)
dle <- distLextreme(dlf=dlf_P, RPs=c(2,10,100), gpd=F)
...
Perhitungan debit banjir di lokasi proyek menggunakan metode yang
disarankan oleh SNI 2415:2016 Tentang Tata Cara Perhitungan Debit Banjir yaitu
metode hidrograf Snyder. Persamaan dari hidrograf
satuan sintetik Snyder-Alexesey sebagai berikut:
